...
const SearchStories = (props) => {
  ...
  //const fetchData = (text) =>{
    // const url = 'https://techieexplorer.com/demo/muthassikathakal/public/api/v1/stories?language=English&per_page=4&search='+props.searchPhrase;
    // useEffect(() => {
    //   fetch(url, {
    //           method: 'GET',
    //           headers: {
  ...
  return(
      <View style={styles.storyContainer} onStartShouldSetResponder={() => {props.setClicked(false);}}>
        {!props.storyListDynamic ? (
