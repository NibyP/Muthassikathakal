...
const LatestStories = () => {
  ...
  useEffect(() => {
    fetch('https://techieexplorer.com/demo/muthassikathakal/public/api/v1/stories?language=English&per_page=4', {
            method: 'GET',
            headers: {
  ...
  return(
      <View style={styles.storyContainer} >
              <View style={styles.titleContainer}>
                    ...
                    <TouchableOpacity   style={styles.viewMore} onPress={ () => navigation.navigate('Stories', { latest:'yes' })}><Text>View All</Text></TouchableOpacity>
              </View>
              <FlatList
